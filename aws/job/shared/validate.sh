...
validate_all_templates(){
  validate_template "container/resources/ec2/vpc/vpc.yaml"
  validate_template "container/resources/ec2/routetable/routetable.yaml"
  validate_template "container/resources/ec2/securitygroup/rules/noaccess.yaml"
}
